...
class Machine:
    def __init__(self):       
        ...
        display = PhotoImage(file="Slot_Machine.png")
...
#-----------------------------------------------------------------------------------------------------------------------------        
    ...
    # First Wheel 
        ...
        if self.wheel1 == 1:
            fir_image = self.images[1]
        elif self.wheel1 == 2:
            fir_image = self.images[2]
        else:
            fir_image = self.images[3]
                               
        first_wheel = Label(self.main_window, image=fir_image)    
        first_wheel.grid(row=1, sticky="W")
    # Second Wheel
        self.wheel2 = wheel_image.spin() 
                       
        if self.wheel2 == 1:
            sec_image = self.images[1]
        elif self.wheel2 == 2:                
            sec_image = self.images[2]
        else:
            sec_image = self.images[3]
                                
        second_wheel = Label(self.main_window, image=sec_image)
        second_wheel.grid(row=1)
    # Third Wheel            
        self.wheel3 = wheel_image.spin() 
                       
        if self.wheel3 == 1:                
            thir_image = self.images[1]
        elif self.wheel3 == 2: 
            thir_image = self.images[2]
        else:                
            thir_image = self.images[3] 
                               
        third_wheel = Label(self.main_window, image=thir_image)
